...
export default function App({ Component, pageProps }) {
  ...
  const title = "Portfolio | Bipin Giri";
  const description =
    "Hello! I'm Bipin Giri, a passionate web developer and problem solver. Welcome to my portfolio";
  const avatar =
  ...
  const url = "https://bipingiri77.com.np/";
